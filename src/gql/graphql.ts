...
export type CategoryPageBySlugQuery = {
	categories: Array<{ id: string; name: string; description?: string | null; slug: string }>;
	products: {
		...
		edges: Array<{
			node: {
				...
				images: Array<{ id: string; height?: number | null; url: string; width?: number | null }>;
			};
		}>;
		pageInfo: { hasNextPage: boolean; hasPreviousPage: boolean; pageSize?: number | null };
	};
};

export type CollectionPageCollectionsQueryVariables = Exact<{ [key: string]: never }>;

export type CollectionPageCollectionsQuery = {
	collections: Array<{
		id: string;
		name: string;
		description?: string | null;
		slug: string;
		image: { height?: number | null; width?: number | null; url: string };
	}>;
};
...
export type CollectionPageBySlugQuery = {
	collections: Array<{
		id: string;
		name: string;
		description?: string | null;
...
export type ProductPageByIdQuery = {
	product?: {
		id: string;
		name: string;
		slug: string;
...
export type ProductPageRelatedQuery = {
	products: Array<{
		id: string;
		name: string;
		slug: string;
...
export type ProductBaseFragment = {
	id: string;
	name: string;
	slug: string;
	description: string;
...
export type OrdersGetByEmailQuery = {
	orders: Array<{
		...
		orderItems: Array<{
			...
			quantity: number;
			total: number;
			product?: { name: string; price: number; images: Array<{ url: string }> } | null;
		}>;
	}>;
};
...
export const AggregateFragmentDoc = new TypedDocumentString(
  ...
  count
    ...
    `,
	{ fragmentName: "Aggregate" },
) as unknown as TypedDocumentString<AggregateFragment, unknown>;
...
) as unknown as TypedDocumentString<ProductBaseFragment, unknown>;
...
export const CollectionPageCollectionsDocument = new TypedDocumentString(`
  ...
  image {
	...
	CollectionPageCollectionsQuery,
	CollectionPageCollectionsQueryVariables
>;
...
fragment ProductBase on Product {
  ...
  images {
	...
	CollectionPageBySlugQuery,
	CollectionPageBySlugQueryVariables
>;
