...
export type CategoryPageBySlugQueryVariables = Exact<{
  slug: Scalars['String']['input'];
...
export type ProductPageByIdQuery = { product?: { id: string, name: string, slug: string, description: string, price: number, averageRating?: number | null, variants: Array<{ __typename: 'ProductColorVariant' } | { __typename: 'ProductSizeColorVariant', id: string, name: string, size: ProductSize, color: ProductColor } | { __typename: 'ProductSizeVariant' }>, collections: Array<{ id: string, name: string }>, categories: Array<{ id: string, name: string }>, reviews: Array<{ id: string, content: string, email: string, headline: string, name: string, rating: number }>, images: Array<{ id: string, height?: number | null, url: string, width?: number | null }> } | null };
...
export type ProductPageRelatedQuery = { products: Array<{ id: string, name: string, slug: string, description: string, price: number, averageRating?: number | null, categories: Array<{ id: string, name: string }>, images: Array<{ id: string, height?: number | null, url: string, width?: number | null }> }> };
...
export type AggregateFragment = { count: number };
...
export type CartFragment = { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, price: number, description: string, images: Array<{ id: string, url: string }> } | null }> };

export type PageInfoFragment = { hasNextPage: boolean, hasPreviousPage: boolean, pageSize?: number | null };

export type ProductBaseFragment = { id: string, name: string, slug: string, description: string, price: number, averageRating?: number | null, categories: Array<{ id: string, name: string }>, images: Array<{ id: string, height?: number | null, url: string, width?: number | null }> };

export type ReviewFragment = { id: string, content: string, email: string, headline: string, name: string, rating: number };
...
export type CartCreateMutation = { createOrder?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, price: number, description: string, images: Array<{ id: string, url: string }> } | null }> } | null };
...
export type CreateReviewMutation = { createReview?: { id: string, content: string, email: string, headline: string, name: string, rating: number } | null, updateProduct?: { id: string } | null };
...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, price: number, description: string, images: Array<{ id: string, url: string }> } | null }> } | null };
...
export type ProductGetByIdQuery = { product?: { id: string, name: string, slug: string, description: string, price: number, averageRating?: number | null, categories: Array<{ id: string, name: string }>, images: Array<{ id: string, height?: number | null, url: string, width?: number | null }> } | null };
...
export const AggregateFragmentDoc = new TypedDocumentString(`
    fragment Aggregate on Aggregate {
  count
}
    `, {"fragmentName":"Aggregate"}) as unknown as TypedDocumentString<AggregateFragment, unknown>;
